// function to create coffee container and coffee cards for the menu
function createMenu() {
  ...
  // adding all the coffee cards to the coffee container
...
// adding them to main and loading to the page
function loadMenu() {
